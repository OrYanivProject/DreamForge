...
import { getPathString, pathSegmentCollection, processPathData, splitArrayCollection, transformPath } from '../utility/path-util';
                    ...
                    for (var i = 0; i < widgetInfo.length; i++) {
                        ...
                        for (var j = 0; j < widget.length; j++) {
                            ...
                            if (i == widgetInfo.length - 1 && widgetInfo.length > 1) {
                                ...
                                var lastLine = widgetInfo.keys[i].paragraph.lastChild;
                                if (!isNullOrUndefined(lastLine) && widgetInfo.keys[i] === lastLine && lastLine.children[lastLine.children.length - 1] instanceof ContentControl && lastLine.children[lastLine.children.length - 1] === contenControl.reference && contenControl.contentControlWidgetType === 'Block') {
                                    ...
                                    //top
                                    if (widgetInfo.length > 1) {
                                        var widgets_1 = widgetInfo.get(widgetInfo.keys[i - 1]);
                                        ...
                                        if (startX < widgets_1[j].left - 2) {
                                            this.renderSingleBorder(color, widgets_1[j].left - 2, startY, startX, startY, 1, 'single');
                                        }
                                    }
                                }
                                //right
                        ...
                        if (spellInfo.isElementPresent && this.spellChecker.enableOptimizedSpellCheck) {
                            ...
                            if (this.spellChecker.isInUniqueWords(retrievedText)) {
                                ...
                                this.spellChecker.callSpellChecker(this.spellChecker.languageID, checkText, true, this.spellChecker.allowSpellCheckAndSuggestion).then(function (data) {
                                    ...
                                    if (!isNullOrUndefined(_this.spellChecker)) {
