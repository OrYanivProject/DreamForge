...
export declare class Editor {
    ...
    */
     ...
     * If a content control with the specified `title` and `tag` is found, it will be updated with the new information.
     *
     * @param {ContentControlInfo} An object containing the updated details for the content control.
    ...
    * @private
    */
    removeContentControlInternal(): void;
    /**
     ...
     * @returns {void}
     */
    constructRevisionFromID(insertElement: any, isEnd: boolean, prevElement?: ElementBox, index?: number): void;
    /**
    ...
    * @returns {void}
    */
    toggleContentControlCheckBox(contentControl: ContentControl): void;
    /**
     * @param field
     * @param value
     * @param reset
