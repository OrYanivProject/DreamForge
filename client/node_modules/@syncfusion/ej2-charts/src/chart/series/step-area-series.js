...
var StepAreaSeries = /** @class */ (function (_super) {
    ...
    StepAreaSeries.prototype.render = function (series, xAxis, yAxis, isInverted, pointAnimate, pointUpdate) {
        ...
        if (series.border.width !== 0) {
            var options_1 = new PathOption(series.chart.element.id + '_Series_border_' + series.index, 'transparent', series.border.width, series.border.color ? series.border.color : series.interior, 1, series.dashArray, borderDirection);
