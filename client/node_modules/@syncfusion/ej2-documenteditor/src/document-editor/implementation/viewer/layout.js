...
var Layout = /** @class */ (function () {
   ...
   */
    ...
    */
    ...
    Layout.prototype.moveEndnoteToNextPage = function (endnote, bodyWidget, isMoveEntireEndnote) {
        if (isMoveEntireEndnote) {
            ...
            var currentIndex = bodyWidget.index;
            ...
            if (isNullOrUndefined(page.endnoteWidget)) {
                ...
                for (var i = currentIndex + 1; i < endnote.bodyWidgets.length; i++) {
            ...
            // if the page has a endNoteWidget, we move the endnote to next page.
                ...
                for (var i = endnote.bodyWidgets.length - 1; i > currentIndex; i--) {
                    var currentBodyWidget = endnote.bodyWidgets[i];
 ...
 */
    ...
    Layout.prototype.reLayoutOrShiftWidgets = function (blockAdv, viewer, isMultiColumnShift) {
        var block = blockAdv;
    ...
    Layout.prototype.moveBlocksToNextPage = function (block, moveFootnoteFromLastBlock, childStartIndex, sectionBreakContinuous, isEndnote) {
